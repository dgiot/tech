...
1.  在创建规则界面，输入 **规则SQL**，并启用 **SQL 测试** 开关:
    ...
    ![sql-test-1@2x.7f6fdc2d.png](http://dgiot-1253666439.cos.ap-shanghai-fsi.myqcloud.com/shuwa_tech/zh/backend/dgiot/rule-engine/sql-test-1%402x.7f6fdc2d.png)

2.  修改模拟事件的字段，或者使用默认的配置，点击 **测试** 按钮:

   ![sql-test-2@2x.efe87e20.png](http://dgiot-1253666439.cos.ap-shanghai-fsi.myqcloud.com/shuwa_tech/zh/backend/dgiot/rule-engine/sql-test-2%402x.efe87e20.png)

3.  SQL 处理后的结果将在 **测试输出** 文本框里展示:

   ![sql-test-3@2x.0b6301b0.png](http://dgiot-1253666439.cos.ap-shanghai-fsi.myqcloud.com/shuwa_tech/zh/backend/dgiot/rule-engine/sql-test-3%402x.0b6301b0.png)
